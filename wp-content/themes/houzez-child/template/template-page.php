...
if( $page_sidebar == 'none' ) {
	...
	$content_area = 'col-lg-12 col-md-12 col-sm-12 col-xs-12 list-grid-area container-contentbar';

} else if( $page_sidebar == 'right_sidebar' ) {
	$content_area = 'col-lg-12 col-md-12 col-sm-12 col-xs-12 container-contentbar';
}
